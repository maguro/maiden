 ...
 *
 */
public class DefaultMethodVisitor implements MarkableMethodVisitor
{
    private final static String CLASS_NAME = DefaultMethodVisitor.class.getName();
    ...
    public DefaultMethodVisitor(MarkableMethodVisitor visitor)
    {
        assert visitor != null;
