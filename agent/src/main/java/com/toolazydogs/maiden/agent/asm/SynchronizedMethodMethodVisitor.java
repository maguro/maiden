 ...
 *
 */
public class SynchronizedMethodMethodVisitor extends DelegateMethodVisitor implements Opcodes
{
    private final static String CLASS_NAME = SynchronizedMethodMethodVisitor.class.getName();
    private final static Logger LOGGER = Logger.getLogger(CLASS_NAME);
    private int line = 0;

    public SynchronizedMethodMethodVisitor(MethodVisitor visitor)
    {
        super(visitor);
    }
    ...
    {
        LOGGER.entering(CLASS_NAME, "visitVarInsn.flush", new Object[]{opcode, var});
