...
import com.toolazydogs.maiden.agent.asm.AsmUtils;


/**
 *
 */
public class LineAnnouncerMethodVisitor implements MarkableMethodVisitor
{
    private final static String CLASS_NAME = LineAnnouncerMethodVisitor.class.getName();
    ...
    public LineAnnouncerMethodVisitor(MarkableMethodVisitor visitor)
    {
        assert visitor != null;
    ...
    public void visitLineNumber(final int line, final Label start)
    {
        ...
        delayed.push(new DelayedMethodVisitor()
        {
            public void flush(MethodVisitor methodVisitor, boolean mark)
            {
                ...
                if (mark)
                {
                    AsmUtils.pushInteger(methodVisitor, line);
                    methodVisitor.visitMethodInsn(Opcodes.INVOKESTATIC, "com/toolazydogs/maiden/IronMaiden", "announceLineNumber", "(I)V");
                }
            }
        });
    }
